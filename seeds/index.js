...
const seedDB = async () => {
  ...
  for (let i = 0; i < 300; i++) {
    ...
    const camp = new Campground({
      ...
      images: [
        {
          url: 'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8Y2FtcGluZ3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=400&q=60',
